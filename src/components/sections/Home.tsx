...
function Home() {
  return (
    <main id="home">
      <div className="py-12 md:pt-28 gap-8 mx-auto max-w-screen-lg w-11/12 flex flex-col md:flex-row items-center justify-between">
        {/* hero section */}
        <div>
          <div>
            Hi, <span className="text-accent100">I'm</span>
          </div>
        ...
        <div className="animation-blob border-accent100 border-[5px] w-64 md:w-max">
